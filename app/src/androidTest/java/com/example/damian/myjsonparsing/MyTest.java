...
public class MyTest extends ApplicationTest {
    public void testCheckCorrectData() throws IOException {
        ...
        //List<UserData> data;
        //data = MyCitiesController.getAllCities(s);
        //Log.d("mytag", "" + data.size());
        //String json = Utils.LoadFile(MainActivity.getResources(),"cities.json",true);
        //Log.d("mytag",json);
    }
